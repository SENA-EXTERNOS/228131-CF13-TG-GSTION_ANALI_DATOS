...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
            ...
            .col
              .row.justify-content-between.align-items-center
                .col-9.mb-3.mb-sm-0
                  ...
                  p Para conocer más sobre las herramientas de las ciencias de datos visite los siguientes enlaces:
                .col.mb-3.mb-sm-0
                  ...
                  .row.justify-content-center.mb-1
                    .col
                      a.boton.boton--b(:href="('https://www.tensorflow.org/?hl=es-419')" target="_blank")
                        span Enlace web
                        i.fas.fa-link
        ...
        .col-lg-8
          AcordionA.mb-2(tipo="a" clase-tarjeta="tarjeta acordeonA")
            ...
            .row.justify-content-center.mb-4(titulo="Ciberseguridad")
              .col-10
                p.mb-0 Los #[i softwares] de seguridad tradicionales requieren de una intervención humana para identificar vulnerabilidades. Esta parte del proceso se puede realizar de manera más eficiente al aplicar procesos de análisis de datos y técnicas de machine #[i learning] para buscar patrones y proceder a dar la alerta cuando se detectan situaciones que no corresponden al patrón definido.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8
        p(data-aos="fade-down") Cada proyecto de ciencia de datos es único, pero para su correcta ejecución siempre es necesario contar con un plan de trabajo que facilite la comunicación entre los interesados y ayude al trabajo eficiente y articulado del equipo. Para la realización de este plan de trabajo existen diversos enfoques (por ejemplo, el #[i Cross Industry Standard Process for Data Mining] (CRISP-DM) o el #[i Knowledge Discovery in Databases] (KDD)) que en su mayoría presentan un ciclo de vida del proyecto con fases similares. A continuación, se presentan las fases del ciclo de vida que, dependiendo del tipo de proyecto, puede tener más o menos componentes y que son ejecutadas a menudo de forma interactiva.
      .col-lg-4
        figure
    ...
    .tarjeta.tarjeta--gris.p-4
      LineaTiempoC.color-acento-contenido(text-small)
          ...
          .col-md-6.mb-4.mb-md-0
            ...
            ul.lista-ul--color
                li
                  ...
                  .col-12
                    p ¿Cuánto? o ¿cuántos? (regresión)
                li
                  i.fas.fa-chevron-right(style="color:#000000")
                  .col-12
                    p ¿Qué categoría? (clasificación)
                li
                  i.fas.fa-chevron-right(style="color:#000000")
                  .col-12
                    p ¿Qué grupo? (agrupación en clústeres)
                li
                  i.fas.fa-chevron-right(style="color:#000000")
                  .col-12
                    p ¿Es extraño? (detección de anomalías)
                li
                  i.fas.fa-chevron-right(style="color:#000000")
                  .col-12
                    p ¿Qué opción se debe elegir? (recomendación)
        ...
        .row(titulo="Implementación y despliegue")
          .col-md-6.mb-4.mb-md-0
            p Cuando ya se tienen los modelos evaluados y seleccionados se publican y utilizan para procesar otros datos, ya sea en tiempo real o por lotes. Por lo general para la implementación de los modelos se utiliza una interfaz de API (#[i Application Programming Interface] o Interfaz de Programación de Aplicaciones) abierta que permite que el modelo sea utilizado por otras aplicaciones como: tableros de control, sitios web, hojas de cálculo y aplicaciones en línea o móviles. Esta fase es de gran importancia, ya que un modelo solo es útil hasta que el cliente o la organización no puedan acceder a sus resultados.            
        ...
        .row(titulo="Aceptación")
          .col-md-6.mb-4.mb-md-0
            p En esta fase se aborda dos tareas principales: la validación del sistema y la entrega del proyecto. En la validación del sistema se confirma que el proyecto y el modelo implementado cumple con los requisitos iniciales del cliente y en la entrega del proyecto a la organización para su ejecución en un entorno de producción. El cliente debe validar que los resultados finales satisfacen sus necesidades y responden a las preguntas realizadas en la fase de “conocimiento del negocio”. El proyecto debe ser entregado debidamente documentado para que pueda ser aprovechado por el cliente.
    ...
    .row.justify-content-center.mb-5
      ...
      .col-md-10.mb-md-0
        .px-2
          p.mb-0 El concepto #[i Big Data] hace referencia al análisis masivo de datos (que pueden ser estructurados, semiestructurados o no estructurados). Se usa cuando por la cantidad de datos o su complejidad, las herramientas de #[i hardware] y #[i software] tradicionales no son capaces de almacenar y/o procesar dichos datos en un tiempo razonable. Lo que se busca con el #[i Big Data] al interior de las organizaciones, es aprovechar esta gran cantidad de información. Su objetivo es brindar las herramientas y metodologías para poder procesar los datos, analizarlos y obtener de ellos #[i insights] que les brinden una ventaja competitiva y una toma de decisiones soportada en el conocimiento y la experiencia y no en la intuición.
    
    .row.justify-content-center
      .col-md-12
        p.mb-0 Algunos de los beneficios de las organizaciones al usar el #[i Big Data] son:
    ...
    .row.justify-content-center.mb-5
      .tarjeta-avatar
        ...
        .tarjeta.tarjeta--amarilla-1.p-4
          ...
          p.text-center Especialmente en términos de los costos relacionados con el almacenamiento de grandes cantidades de datos gracias a las tecnologías de datos como #[i Hadoop], además de los ahorros que se pueden llegar a generar al optimizar procesos gracias al análisis de la información existente.
      
      .tarjeta-avatar
        img(src='@/assets/curso/temas/tema1/img15.svg' alt='AvatarTop')
        .tarjeta.tarjeta--amarilla-1.p-4
          h2.text-center.mt-5 Mayor velocidad
          p.text-center Las herramientas de #[i Big Data] permiten análisis y procesamiento con una mayor eficiencia y mejor aprovechamiento de la memoria. Esto permite a las organizaciones tomar mejores y más rápidas decisiones.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        p(data-aos="fade-down") En el #[i Big Data] las fuentes de datos son diferentes a las tradicionales que suelen almacenar datos estructurados en bases de datos relacionales. Estos datos son clasificados en tres grandes categorías: datos estructurados, datos no estructurados y datos semiestructurados.

    .row.justify-content-center.align-items-center.md-5
      .col-12
        .titulo-sexto.color-acento-contenido
          h5(data-aos="fade-down") Figura 2
          br
          span #[i Sources of Big Data]
    ...
    .row.justify-content-center.mb-5
      ...
      .col-md-10.mb-md-0
        .px-2
        p(data-aos="fade-down").mb-0 En la actualidad las tecnologías de #[i Big Data] se encuentran en una fase de evolución y maduración con un largo camino por recorrer, pero algunas organizaciones ya empiezan a resaltar como referentes de este campo, es el caso de #[i Apache Foundation] que coordina el desarrollo del #[i software] de código abierto #[i Hadoop]. #[i Hadoop] es un #[i framework] que permite trabajar con aplicaciones distribuidas y además facilita el almacenamiento y procesamiento de grandes cantidades de información.

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        p(data-aos="fade-down").mb-0 El siguiente video describe con más detalle #[i Hadoop] y cómo es utilizado en procesos de #[i Big Data].
      ...
      SlyderA(tipo="b")
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            p Son todas aquellas que provienen de investigaciones internas o de la operación diaria de la propia organización, almacenada en su sistema de información y que puede intercambiarse con clientes y proveedores. En estas fuentes de datos se incluyen todas aquellas que almacenan los datos generados por los procesos internos de la organización como son la gestión comercial, las ventas, los inventarios, los recursos humanos, clientes y demás. Es aquí donde los sistemas de información empresariales cobran gran importancia en el registro y gestión de las actividades (por ejemplo, el CRM: #[i Customer relationship management] - Gestión de relación con el cliente o el ERP: #[i Enterprise resource planning] - Planificador de recursos empresariales).
    ...
    .row.justify-content-center.mb-5
      ...
      .col-md-10.mb-md-0
        .px-2
        p(data-aos="fade-down").mb-4 El objetivo de esta creciente filosofía es el de abrir los datos a la sociedad para que ésta pueda sacar provecho de ellos. Busca que cualquier persona, organización o institución pueda aprovechar toda esta información producida en su mayoría con recursos públicos, para la generación de nuevos conocimientos de interés propio o en procesos de investigación, análisis y desarrollo en problemáticas sociales que se puedan beneficiar de este trabajo colaborativo. Los datos proporcionados en esta modalidad provienen de entidades públicas o fueron financiados con recursos públicos (alcaldías, gobernaciones, ministerios, centros de salud, etc.) e incluyen diferentes temáticas de dichos actores, entre ellos: datos médicos, geográficos, meteorológicos, inventarios, contratación y muchos otros.
    ...
    .row.justify-content-center.align-items-center.md-5
      .col-6
        .titulo-sexto.color-acento-contenido
          h5(data-aos="fade-down") Tabla 2
          br
          span Iniciativas de datos abiertos
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-6
        .tabla-c
          table
    ...
    .row.justify-content-center.align-items-center.md-5
      .col-12
        .titulo-sexto.color-acento-contenido
          h5(data-aos="fade-down") Figura 3
          br
          span Principios datos abiertos
    .row.mb-4.mb-md-5(data-aos="fade-down")
      .bg4
      .row.justify-content-center.align-items-center.mb-5           
        .col-lg-10
          figure
            ...
            figcaption Nota: Adaptada de Guía para el uso y aprovechamiento de Datos Abiertos en Colombia. MinTic. (Pág. 7). Gobierno de Colombia MinTic (mayo, 2019).
        ...
        .col-lg-8
          AcordionA.mb-2(tipo="a" clase-tarjeta="tarjeta acordeonA")
            ...
            .row.justify-content-center.mb-4(titulo="Correlación")
              .col-10
                p.mb-0 En esta se analiza el porcentaje de similitud entre los valores de dos variables numéricas. Esto se realiza mediante modelos matemáticos con el coeficiente de correlación “r” que puede tomar valores entre -1 y 1; cuanto el coeficiente de correlación es igual a -1 o 1 significa que las variables analizadas están fuertemente relacionadas. Si el valor obtenido es igual a 0 las variables no guardan ninguna correlación.
            ...
            .row.justify-content-center.mb-4(titulo="Clasificación")
              .col-10
                p.mb-0 Cada entrada de una base de datos (llamada instancia) pertenece a una clase, indicada mediante el valor del atributo “clase de la instancia” que es un valor discreto que corresponde cada uno a una clase. La técnica de clasificación busca predecir la clase desconocida a la que pertenece una nueva instancia de forma más precisa-, esto lo consigue calculando el cociente entre las predicciones realizadas correctamente y el total de predicciones.
            .row.justify-content-center.mb-4(titulo="Regresión")
              .col-10
                p.mb-0 Es una técnica de predicción que busca aprender una función real para asignar un valor real a una instancia. A diferencia de la clasificación aquí el valor a calcular es numérico. En esta técnica, es muy importante reducir al máximo el error posible entre el valor predicho y el valor real.

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        .cajon.color-acento-botones.cajon--amarillo-1.p-3.p-sm-4
          p(data-aos="fade-down").mb-4 Aprendiz, ha finalizado el estudio del componente formativo, lo invitamos a realizar la actividad didáctica y a revisar el material complementario para afianzar sus conocimientos.
</template>
